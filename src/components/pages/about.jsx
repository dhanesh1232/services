        ...
        <section className="text-center mb-20">
          <div className="bg-gradient-to-r from-indigo-900 to-blue-800 dark:from-slate-800 dark:to-indigo-900 rounded-2xl p-12 text-white shadow-xl transform hover:scale-[1.02] transition-transform">
            ...
            <p className="text-xl md:text-2xl text-slate-100 max-w-4xl mx-auto leading-relaxed">
              ...
              solutions that drive measurable growth and sustainable competitive
              advantage.
            </p>
          </div>
        </section>
        ...
        <section className="mb-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-slate-700 dark:text-slate-300 mb-6 leading-relaxed">
              ...
              trusted digital partner for businesses across multiple industries.
              Our team of strategists, developers, and marketers brings diverse
              perspectives united by a common goal: your success.
            </p>
